with open('packive-dev-rules.md','w',encoding='utf-8') as f:
    f.write("""# Packive Dev Rules & Strategy Guide
> 최종 업데이트: 2026-04-02
...
""")
    print("packive-dev-rules.md created successfully")
    print("File size:", len(open('packive-dev-rules.md','r',encoding='utf-8').read()), "bytes")
