import codecs
content = """# Packive Dev Rules & Strategy Guide
...
with codecs.open('packive-dev-rules.md','w','utf-8') as f:
    f.write(content)

size = len(open('packive-dev-rules.md','r',encoding='utf-8').read())
print(f"packive-dev-rules.md created: {size} bytes")
