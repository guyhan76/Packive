...
| 6-10 | AI 칼선 자동 분류 | 업로드 EPS/SVG에서 칼선/접선/텍스트 AI 자동 분류 (Ungroup 자동화) | 📋 장기 |
| 6-11 | 멀티 모델 AI 허브 | OpenAI/Recraft/Stability 등 백엔드 선택 호출 (Adobe 파트너 모델 대응) | 📋 장기 |
