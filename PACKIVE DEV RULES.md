...
| 3 | 표 만들기 (Illustrator 스타일) | 🔜 다음 |
| 4 | 오른쪽 패널 AI 리뷰 제거 검토 | 📋 대기 |
| 5 | CMYK Soft Proof 미리보기 | 📋 추가 |
| 6 | 특수 인쇄 레이어 (엠보싱/박/실크) | 📋 대기 |
| 7 | Bleed Guide (재단 여백) | 📋 대기 |
| 8 | Panel Map 시스템 | 🚫 Blocked |
| 9 | 별색 Separation PDF | 📋 장기 과제 |